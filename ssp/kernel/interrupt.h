 ...
 */
extern const INHNO	inhinib_inhno[];		/* 割込みハンドラ番号 */
extern const ATR	inhinib_inhatr[];		/* 割込みハンドラ属性 */
extern const FP		inhinib_entry[];		/* 割込みハンドラの出入口処理の番地 */

/*
 *  割込み要求ライン初期化ブロックのエリア（kernel_cfg.c）
 */
extern const INTNO	intinib_intno[];		/* 割込み番号 */
extern const ATR	intinib_intatr[];		/* 割込み属性 */
extern const PRI	intinib_intpri[];		/* 割込み優先度 */
