...
#define LOGTASK_STACK_SIZE	256	/* スタック領域のサイズ */
 ...
 *  システムログタスクの初期化処理
 */
extern void logtask_initialize(ID log_portid) throw();
...
/*
 *  システムログタスクを起動する周期ハンドラ
 */
extern void	cychdr_act_logtsk(intptr_t exinf) throw();
